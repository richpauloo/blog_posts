...
# Note
This is an .Rmd script that I put together for a workshop at the [UC Davis R User's Group](https://d-rug.github.io/blog/2017/Rich-Pauloo-on-using-RMarkdown).  

If you want to follow along with the script and exercies, you can find all of the material (including this .Rmd file) at [this github repo](https://github.com/richpauloo/RMarkdown-workshop). Enjoy!  
